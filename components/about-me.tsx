...
const skillsData = {
  ...
  "Frameworks/SDKs": [
    ...
    { name: "Circom", proficiency: 70 },
    { name: "Anchor", proficiency: 85 },
    { name: "Move", proficiency: 70 },
    { name: "Soroban", proficiency: 75 },
  ],
  Tools: [
    ...
    { name: "Nginx", proficiency: 68 },
    { name: "Metal/RCOM", proficiency: 60 },
